...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Kommunity House | Building Stronger Communities & Creating Opportunities" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "Kommunity House" },
      { property: "og:site_name", content: "Kommunity House" },
